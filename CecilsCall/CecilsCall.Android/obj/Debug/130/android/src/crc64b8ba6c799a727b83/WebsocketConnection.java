...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_RaiseError:(Ljava/lang/Exception;)V:GetRaiseError_Ljava_lang_Exception_Handler\n" +
			...
			"n_RaiseData:([B)V:GetRaiseData_arrayBHandler\n" +
	...
	public void RaiseError (java.lang.Exception p0)
	{
		n_RaiseError (p0);
	}

	private native void n_RaiseError (java.lang.Exception p0);
	...
	public void RaiseData (byte[] p0)
	{
		n_RaiseData (p0);
	}

	private native void n_RaiseData (byte[] p0);
